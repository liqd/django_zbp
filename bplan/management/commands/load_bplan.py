...
def _getPseudoCentroid(multipolygon):
    k = 0
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        result = os.system(
            'ogr2ogr -s_srs EPSG:25833 -t_srs WGS84 -f geoJSON /tmp/re_bplan.json WFS:"http://fbinter.stadt-berlin.de/fb/wfs/geometry/senstadt/re_bplan" re_bplan')
            ...
            for feature in tqdm(data_source[0]):
                ...
                try:
                    if not point.within(multipolygon[0]):
                        point = _getPseudoCentroid(multipolygon)
                    else:
                        pass
                except:
                    pass
